  ...
  guessSelectedCountry = memoize(
    (inputNumber, onlyCountries, defaultCountry) => {
      ...
      const bestGuess = reduce(
        ...
        // cute fix
        {
          dialCode: startsWith(inputNumber, secondBestGuess?.dialCode)
            ? secondBestGuess?.dialCode
            : "",
          priority: 0,
        },
        this
                    ...
                    {!!preferredCountries.length &&
                      map(preferredCountries, (country, index) => (
                        <Item
                          ...
                          localization={
                            localization && localization[country.iso2]
                          }
                          native
                        />
                      ))}
                ...
                <>
                  ...
                  >
                    {!!preferredCountries.length &&
                      preferredCountries
                        .sort((a, b) => {
                          return localization[a.iso2]?.localeCompare(
                            localization[b.iso2],
                            "fr",
                            {
                              sensitivity: "base",
